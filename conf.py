# -*- coding: utf-8 -*-
#
# Continuum Runbooks documentation build configuration file, created by
# sphinx-quickstart on Fri Apr 29 08:09:06 2016.
#
...
def get_git_branch():
    ...
    raw_branch = subprocess.check_output([cmd], shell=True).strip()
    return raw_branch
...
#html_title = u'Continuum Runbooks v1.0'
...
htmlhelp_basename = 'ContinuumRunbooksdoc'
...
#pdf_styles = "_themes/bootstrap/static/css"
# Optional. Use a shorter name to conserve nav. bar space.
html_short_title = 'Continuum Runbooks'
